...
const source: Language = {
  ...
  'Kéo thả biểu tượng _ để sắp xếp lại vị trí':
    'Kéo thả biểu tượng {icon} để sắp xếp lại vị trí',
  ...
  'Đã quá 7 ngày kể từ tin nhắn cuối cùng. _':
    'Đã quá 7 ngày kể từ tin nhắn cuối cùng. {link}',
  ...
  v1: {
    ...
    view: {
      ...
      onboarding: {
        ...
        company_question: 'Tên công ty của bạn là gì?',
        ...
        company_summary: 'Trang đại diện công ty bạn là gì?',
        company_summary_description:
          'Website, Fanpage Facebook, Instagram Page hoặc TikTok Page sẽ giúp chúng tôi đề xuất các giải pháp tốt nhất cho kênh của bạn đang kinh doanh',
        ...
        preference_1: 'Chỉ mình tôi',
        preference_2: '2 đến 5',
        preference_3: '6 đến 10',
        preference_4: '11 đến 25',
        preference_5: '26 đến 50',
        preference_6: '51 đến 200',
        preference_7: '201 đến 1,000',
        preference_8: 'nhiều hơn 1,0001+',

        website_company: 'Trang web công ty',
        ...
        you_are_doing_great: 'Bạn đang làm rất tốt',
        loading_description:
          'Chỉ còn vài câu hỏi nữa để giúp Retion hoạt động tốt hơn cho bạn!',
        ...
        dashboard: {
          ...
          org: {
            ...
            pay: {
              ...
              note: 'Giảm 40% cho lần kích hoạt gói đầu tiên, áp dụng cho cả gói tháng và gói năm',
              support_group: 'Hỗ trợ & giải đáp trong nhóm hỗ trợ chung',
              _detail: 'Chi tiết',
              advanced_support:
                'Hỗ trợ riêng 1:1 trong nhóm hỗ trợ, kèm hướng dẫn thiết lập ban đầu',
              trial: 'Dùng thử (Pro)',
              business: 'Doanh nghiệp',
              pro: 'Pro',
              pro_2: 'Pro 2x',
              ...
              recharge: {
                ...
                success_desc: 'Chúc mừng bạn đã thanh toán thành công',
                amount: 'Số tiền nạp',
                amount_description:
