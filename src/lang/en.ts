...
const source: Language = {
  ...
  'Áp dụng': 'Apply',
  'Kéo thả biểu tượng _ để sắp xếp lại vị trí':
    'Drag the icon {icon} to rearrange the position',
  'Chỉnh sửa vị trí': 'Edit position',
  'Chợ ứng dụng': 'Application market',
  'Hiển thị tự động': 'Auto display',
  'Luôn hiển thị': 'Always visible',
  'Đã quá 7 ngày kể từ tin nhắn cuối cùng. _':
    'More than 7 days from the last message. {link}',
  ...
  'Lấy danh sách trả lời nhanh từ trang khác':
    'Get a quick reply list from another page',
  ...
  'Nhập số điện thoại muốn tìm kiếm':
    'Enter the phone number you want to search',
  'Nhập số điện thoại để thêm khách hàng':
    'Enter the phone number to add a customer',
  ...
  v1: {
    ...
    view: {
      ...
      onboarding: {
        personal_experience: 'Create your personalized experience',
        two_minutes: 'About 2 minutes',
        step_industry: 'Which industry are you in?',
        step_industry_description:
          'We will customize your experience based on your choice.',
        step_role: 'What role are you in?',
        step_role_description:
          'This will help us personalize your experience based on the role you take on.',
        company_question: 'What is your company name?',
        company_question_description:
          'We will use your company name to make the experience feel more familiar.',
        company_preferences: 'What is the size of your company?',
        company_preferences_description:
          'We will use this information to suggest the most suitable solution package for your business.',
        company_summary: 'What is your company’s representative page?',
        company_summary_description:
          'A website, Facebook Fanpage, Instagram Page, or TikTok Page will help us suggest the best solutions for the channels your business is using.',
        industry_1: 'Marketing and Advertising',
        industry_2: 'Technology and Services',
        industry_3: 'Computer Software',
        industry_4: 'Real Estate',
        industry_5: 'Financial Services',
        industry_6: 'Health, Fitness, and Sports',
        industry_7: 'Education',
        industry_8: 'Consulting',
        industry_9: 'Travel and Food',
        step_of: 'of',
        role_1: 'Business Owner',
        role_2: 'Executive Team',
        role_3: 'Manager',
        role_4: 'Employee',
        role_5: 'Student',
        role_6: 'Intern',
        ...
        preference_1: 'Just me',
        preference_2: '2 to 5',
        preference_3: '6 to 10',
        preference_4: '11 to 25',
        preference_5: '26 to 50',
        preference_6: '51 to 200',
        preference_7: '201 to 1,000',
        preference_8: 'More than 1,000+',

        website_company: 'Company Website',
        enter_website: 'companywebsite.com',
        facebook_page: 'Facebook Page',
        enter_facebook: 'username_company',
        instagram_page: 'Instagram Page',
        enter_instagram: 'username_company',
        tiktok_page: 'TikTok Page',
        enter_tiktok: 'username_company',
        zalo: 'Zalo',
        enter_zalo: 'username_company',
        create_account: 'Create Account',
        step_5_description:
          'Your data will be hosted in Singapore. By creating an account you are agreeing to the ',
        step_5_description_2: 'Retion Customer Terms of Service',
        verify_account: 'Verify Account',
        verify_account_description:
          'We need to verify your account to support, guarantee, and secure your account.',
        verify_your_account: 'Verify Your Account',
        phone: 'Phone Number',
        enter_phone: 'Enter phone number',
        verify_now: 'Verify Now',
        you_are_doing_great: 'You are doing great',
        loading_description:
          'Just a few more questions to help Retion work better for you!',
        ...
        connect_social: 'Connect Platforms',
        connect_social_description:
          'Share your current toolset so we can connect with over 1,500+ integrations, helping your business generate more leads.',
        skip_for_now: 'Skip, for now',
        invite_staff: 'Finally, who would you like to invite?',
        invite_staff_desctiption:
          'Invite your team to start generating leads together, or you can add them later if it’s not convenient right now.',
        connected: 'Connected',
        connect: 'Connect',
        validate_website:
          'Invalid website. Example: example.com or https://example.com',
        ...
        dashboard: {
          ...
          org: {
            ...
            pay: {
              ...
              note: '40% off your first plan — monthly or yearly!',
              _detail: 'Detail',
              support_group:
                'General support & Q&A in the public support group',
              advanced_support:
                'Private 1:1 support within the support group, including initial setup guidance',
              trial: 'Trial (Pro)',
              business: 'Business',
              pro: 'Pro',
              pro_2: 'Pro 2x',
              ...
              upgrade: {
                ...
                _15_months: '15 months',
                _18_months: '18 months',
                _21_months: '21 months',
                _24_months: '24 months',
                _27_months: '27 months',
                _30_months: '30 months',
                _33_months: '33 months',
                _36_months: '36 months',

                choose_month: 'Subscription Duration',
              },
              recharge: {
