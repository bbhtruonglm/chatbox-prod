<template>
    <div class="hidden md:flex w-[60px] border-l flex-col items-center md:pt-[80px] xl:pt-[88px]">
...
import FilterBarItem from '@/views/Main/Dashboard/Chat/LeftBar/FilterBar/FilterBarItem.vue'
