    ...
    >
      ...
      >
        ...
        <p class="text-sm text-gray-800 font-medium">
          {{ $t('v1.view.onboarding.lite_subtitle') }}
        </p>
      </div>
      <!-- B -->
      <div
      ...
      <div
        ref="cardC"
        key="c"
        class="card c-card flex flex-col"
      >
      ...
      <div
        ref="cardD"
        key="d"
        class="card d-card flex gap-5"
      >
        <div class="flex flex-col gap-5">
          D1231231231231233121223
          <p class="text-sm text-gray-800 font-medium">
            {{ $t('v1.view.onboarding.lite_subtitle') }}
          </p>
        </div>
        <div
          class="border rounded-lg bg-white h-full w-full"
