...
import UserInfo from '@/views/Dashboard/Chat/CenterContent/UserInfo.vue'
import MessageList from '@/views/Dashboard/Chat/CenterContent/MessageList.vue'
import InputChat from '@/views/Dashboard/Chat/CenterContent/InputChat.vue'
import ChangeStaff from '@/views/Dashboard/Chat/CenterContent/ChangeStaff/ChangeStaff.vue'

import BottomWidgetModal from '@/views/Dashboard/Chat/CenterContent/BottomWidgetModal.vue'
import AttachmentViewModal from '@/views/Dashboard/Chat/CenterContent/AttachmentViewModal.vue'
import StaffReadModal from '@/views/Dashboard/Chat/CenterContent/StaffReadModal.vue'
