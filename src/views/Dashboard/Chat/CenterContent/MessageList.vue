...
import MessageDate from '@/views/Dashboard/Chat/CenterContent/MessageList/MessageDate.vue'
import ClientMessageDate from '@/views/Dashboard/Chat/CenterContent/MessageList/ClientMessageDate.vue'
import TimeSplit from '@/views/Dashboard/Chat/CenterContent/MessageList/TimeSplit.vue'
import ChatbotMessage from '@/views/Dashboard/Chat/CenterContent/MessageList/ChatbotMessage.vue'
import AttachmentMessage from '@/views/Dashboard/Chat/CenterContent/MessageList/AttachmentMessage.vue'
import UnsupportMessage from '@/views/Dashboard/Chat/CenterContent/MessageList/UnsupportMessage.vue'
import ClientTextMessage from '@/views/Dashboard/Chat/CenterContent/MessageList/ClientTextMesage.vue'
import PageTextMessage from '@/views/Dashboard/Chat/CenterContent/MessageList/PageTextMessage.vue'
import PageTempTextMessage from '@/views/Dashboard/Chat/CenterContent/MessageList/PageTempTextMessage.vue'
import PageMessageError from '@/views/Dashboard/Chat/CenterContent/MessageList/PageMessageError.vue'
import SystemMessage from '@/views/Dashboard/Chat/CenterContent/MessageList/SystemMessage.vue'
import NoteMessage from '@/views/Dashboard/Chat/CenterContent/MessageList/NoteMessage.vue'
import ClientRead from '@/views/Dashboard/Chat/CenterContent/MessageList/ClientRead.vue'
import StaffRead from '@/views/Dashboard/Chat/CenterContent/MessageList/StaffRead.vue'
import AdMessage from '@/views/Dashboard/Chat/CenterContent/MessageList/AdMessage.vue'
import FacebookPost from '@/views/Dashboard/Chat/CenterContent/MessageList/FacebookPost.vue'
import ReplyMessage from '@/views/Dashboard/Chat/CenterContent/MessageList/ReplyMessage.vue'
