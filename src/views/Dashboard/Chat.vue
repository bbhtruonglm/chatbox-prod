<template>
    <div @dragover.prevent @drop="onDropFile" class="w-full h-full pt-[65px] md:pt-8 xl:pt-0 md:flex relative bg-white">
        <LeftBar />
        <CenterContent />
        <RightBar />
    </div>
...
import LeftBar from '@/views/Dashboard/Chat/LeftBar.vue'
import CenterContent from '@/views/Dashboard/Chat/CenterContent.vue'
import RightBar from '@/views/Dashboard/Chat/RightBar.vue'
